<html><head></head><body>
  <script>
    ...
    function getInfoFromGoogleClassRoom() {
      finalCourseDetailsWithMeetingLinksList=[]
      ...
      // localStorage.setItem('finalCourseDetailsWithMeetingLinksList', finalCourseDetailsWithMeetingLinksList );


    }

//This function is linked to the "Get Links" button and will do the same thing as the function above and put the data on home.php
    function getLinksButton() {
      ...
      //document.write("<div><h1>"+finalUserName+"</h1></div>")
      var name = finalUserName
      //document.write("<p id='userName'></p>");
      document.getElementById("userName").innerHTML = name;
      //document.write(finalCourseDetailsWithMeetingLinksList);


      localStorage.setItem('finalCourseDetailsWithMeetingLinksList', JSON.stringify(finalCourseDetailsWithMeetingLinksList));
